...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'business@molibee.com,eddiehan@molibee.com';
 ...
 */
  ...
  */
   ...
   * @return string
   */
  public function AddrAppend($type, $address) {
    $address_str = $type . ': ';
    $addresses = array();
  ...
  public function AddrFormat($address) {
    if (empty($address[1])) {
      ...
      return $this->EncodeHeader($this->SecureHeader($address[1]), 'phrase') . " <" . $this->SecureHeader($address[0]) . ">";
    }
  }
