...
$config['mongo_db']['default']['hostname'] = 'log.longeplay.com.tw';
$config['mongo_db']['default']['port'] = '27017';
$config['mongo_db']['default']['username'] = 'longe';
$config['mongo_db']['default']['password'] = 'longeplay';
$config['mongo_db']['default']['database'] = 'longe_log';
...
$config['mongo_db']['test']['database'] = 'longe_log';
$config['mongo_db']['test']['db_debug'] = TRUE;
$config['mongo_db']['test']['return_as'] = 'array';
$config['mongo_db']['test']['write_concerns'] = (int)1;
$config['mongo_db']['test']['journal'] = TRUE;
