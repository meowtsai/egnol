<div id="le_header">
  <div id="nav_bar">
	...
	</div><div class="nav_frm"><a class="nav_link" href="https://www.facebook.com">粉絲團</a>
	</div><div class="nav_frm"><a class="nav_link" href="/service?site=<?=$site?>">客服中心</a>
	</div><div class="nav_frm"><a class="nav_link" href="/member?site=<?=$site?>"><?= $this->g_user->is_login() ? "會員資料" : "會員登入" ?></a></div>
  </div>
</div>