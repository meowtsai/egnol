              ...
              <? if ($this->g_user->check_login($this->game)):?>
					...
					<? if ($this->server['new']): 
			      		...
			      		<!-- <div style="padding:5px 0 10px;">
			      			新服：				
			        		<a href="<?=$url?>" target="_top"><img src="/p/img/server/<?=$this->server['new']->server_id?>n_off.jpg" class="change" style="vertical-align:middle" /></a>
			        	</div> -->
			        		<? endif;
			        	endif;?>   	            
    ...
    <div id="inright">
    	...
    	<div id="r_01">
            ...
            <div class="r_01-2">
                ...
                <div id="banner_2">
                	<div style="background:#fff;" class="fb-like-box" data-href="https://www.facebook.com/long_e.inc" data-width="240" data-height="260" data-colorscheme="" data-border-color="" data-show-faces="true" data-stream="false" data-header="false"></div>
                </div>
            </div>
        </div>
        <div id="r_02">
