...
jQuery.fn.slideViewerPro = function(settings) {
	...
	return this.each(function(){
		...
		var thumb_slider = jQuery("div#thumbSlider" + j); 
		container.on("mouseenter", function(){
			thumb_slider.stopSlide();
			console.log('over');
    ...
    .wrap(jQuery("<div style='width:"+ pictWidth +"px; overflow: hidden; position: relative; top: 0; left: 0'>"));
		container.each(function(i) {
			...
			jQuery(this).find("li").each(function(n) { 
						var src = jQuery(this).find("img").attr("thumb");
						thumbsWidth = 160;
						thumbsHeight = 36
						jQuery("div#thumbSlider" + j + " ul").append("<li><a title='" + jQuery(this).find("img").attr("alt") + "' href='#'><img width='"+ thumbsWidth +"' height='"+ thumbsHeight +"' src='" + src + "' /><p class='tmbrdr'>&nbsp;<\/p><\/a><\/li>");						
			});
			...
			thumb_slider.slide = function() {
				var i = 1;				
				
				jQuery('.thumbSlider').everyTime(settings.asTimer, "asld", function() {			
			...
			thumb_slider.stopSlide = function() {
				jQuery('.thumbSlider').stopTime("asld");
			}
