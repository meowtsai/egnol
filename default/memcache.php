...
define('ADMIN_USERNAME','long_e'); 	// Admin Username
define('ADMIN_PASSWORD','long_e.memcache!@#$');  	// Admin Password
define('DATE_FORMAT','Y/m/d H:i:s');
define('GRAPH_SIZE',200);
define('MAX_ITEM_DUMP',50);

$MEMCACHE_SERVERS[] = 'localhost:12321'; // add more as an array
//$MEMCACHE_SERVERS[] = '172.16.0.203:12321'; // add more as an array
