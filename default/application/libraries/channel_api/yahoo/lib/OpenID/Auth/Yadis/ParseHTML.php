...
class Auth_Yadis_ParseHTML {
    ...
    function getMetaTags($html_string)
    {
        ...
        $key_tags = array($this->tagsPattern('html', false, false),
                          $this->tagsPattern('head', false, false),
                          $this->tagsPattern('head', true, false),
                          $this->tagsPattern('html', true, false),
                          $this->tagsPattern(array(
        ...
        if (!preg_match_all($this->tagsPattern('meta', false, 'maybe'),
