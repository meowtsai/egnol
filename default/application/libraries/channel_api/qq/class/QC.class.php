...
class QC extends Oauth{
    ...
    public function __construct($access_token = "", $openid = ""){
        ...
        $this->APIMap = array(
            ...
            "get_tenpay_address" => array(
                "https://graph.qq.com/cft_info/get_tenpay_address",
    ...
    public function __call($name,$arg){
        ...
        //对于get_tenpay_address，特殊处理，php json_decode对\xA312此类字符支持不好
        if($name != "get_tenpay_address"){
