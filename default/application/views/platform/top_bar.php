...
#skybar {position:relative; width:100%; left:0px; top:0px; z-index:999; height:45px; background:url(/p/img/top_bar_bk.jpg) #fff; line-height:18px;}
#skybar a {color:#666;}
...
#sb_select .game_center {background:url(/top/images/center_bk.jpg) no-repeat 0 11px;  padding-right:10px;}
#sb_select .game_center a {margin-left:-5px;}

#sb_game_list {width:708px; position:absolute; top:42px; right:0; z-index:99992}
#game_list {background:url('/top/images/list_mid.png');}

</style>
<div id="sb_topbar">
	<span id="sb_logo"><a href="/" target="_blank"><img src="/top/images/logo.jpg"/></a></span>
	<? if ($skybar_banner):?>
    ...
    <div id="sb_select">
    	<ul>
        	<li class="item"><a href="/payment">儲值中心</a> │</li>
            <li class="item"><a href="/member/update_member_data">會員中心</a> │</li>
            <li class="item"><a href="/service">客服中心</a> │</li>
            <li class="item game_center"><a href="javascript:;">遊戲中心</a></li>
        </ul>
    </div>
	<div id="sb_game_list" style="display:none;">  
		<img src="/top/images/list_top.png" /><? $this->load->view("platform/_game_list", array("game_a"=>$game_a, "game_b"=>$game_b, "game_c"=>$game_c, "game_d"=>$game_d, "game_e"=>$game_e));?>
 		<img src="/top/images/list_foot.png" />
	</div>      
