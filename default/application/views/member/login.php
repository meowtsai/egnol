...
?>
			<a href="<?=base_url();?>/gate/login/<?=$site?>?channel=<?=$channel?>&ad=<?=$ad?>&redirect_url=<?=urlencode($redirect_url)?>&"><img src="<?=base_url();?>/img/login/<?=$channel?>.png" width="40" title="<?=$name?> 帳號登入" border="0"/></a>
			<? endforeach;?>
		</div>
   </td>
  </tr>
