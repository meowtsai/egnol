...
<div id="content-login">
	<div class="login-ins">
		<div class="bread cf" typeof="v:Breadcrumb">
			<a href="<?=$game_url?>" title="首頁" rel="v:url" property="v:title">首頁</a> > <a href="<?=$longe_url?>member?site=<?=$site?>" title="會員資料" rel="v:url" property="v:title">會員資料</a> > <a href="<?=$longe_url?>member/update_profile?site=<?=$site?>" title="修改資料" rel="v:url" property="v:title">修改資料</a>
		</div>
		<form name="member_update" id="member_update" method="post" action="<?=$longe_url?>member/update_profile_json?site=<?=$site?>">
			...
			<div class="login-form">
				<table class="member_info">
					...
					<tr>
						<th>姓　　名</th><td><input type="text" maxlength="12" name="name" value="<?=$user_info->name?>" size="33"></td>
					</tr>
					<tr>
						<th>性　　別</th>
						<td>
					...
					<tr>
						<th>地　　址</th><td><input type="text" maxlength="30" name="address_road" value="<?=$user_info->street?>" size="33"></td>
					</tr>
					<tr>
