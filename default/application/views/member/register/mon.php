...
?>
	<a href="http://www.longeplay.com.tw/gate/login/mon?channel=<?=$channel?>&ad=<?=$ad?>"><img src="http://www.longeplay.com.tw/img/login/<?=$channel?>.png" width="31" title="<?=$name?> 帳號登入"/></a>
<? endforeach;?>
