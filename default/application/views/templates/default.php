...
<link rel='stylesheet' type='text/css' href='<?=base_url();?>/p/css/common.css'>
<link rel='stylesheet' type='text/css' href='<?=base_url();?>/p/css/default.old.css'>
<link rel='stylesheet' type='text/css' href='<?=base_url();?>/p/css/jquery-ui-1.8.22.custom.css'>
...
<table width="996" border="0" align="center" cellpadding="0" cellspacing="0" background="<?=base_url();?>/img/Template-bg.jpg">
  <tr> 
    <td width="305"><a href="/index.php"><img src="<?=base_url();?>/img/logo.gif" height="42" border="0" /></a></td>
  ...
  <tr> 
    <td colspan="3" style="padding-top:50px;">   
		<table width="762" border="0" align="center" cellpadding="0" cellspacing="0">
			<tr>
	          <td height="37" background="<?=base_url();?>/img/Template-img-01.gif">
 	 	...
 	 	<table border="0" cellspacing="0" cellpadding="3">
              <tr> 
                <td align="center" class="text-gray-light"><div align="center"><a href="/aboutUs.php">關於我們</a> 
                    ...
                    | <a href="<?=base_url();?>/service">客服中心</a> | </div></td>
              </tr>
              <tr> 
