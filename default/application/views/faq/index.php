...
<style type="text/css">
    ...
    .search_box .search_string{width:70%; height:33px; text-align:left; font-weight: bold; background-color:#E7DAB8;}
	...
	<div class="login-ins">
		<div class="login_box">
                <form id="faq_form" class="search_box" enctype="multipart/form-data" method="post" action="<?=$longe_url?>faq?site=<?=$site?>">
                    ...
                    <input type="submit" class="btn btn-small btn-inverse search_btn" name="action" value="查詢"><? if ($bodyonly):?>
                    <input type="button" class="btn btn-small btn-inverse search_btn" onclick="location.href='<?=$longe_url?>faq?site=<?=$site?>&bodyonly=true&hidetitle=true';" value="首頁">
                    <? endif;?>
                </form>
