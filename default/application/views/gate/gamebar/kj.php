...
<div style="background:url(/p/img/gamebar/bw/bg02.png) 0 -6px; height:35px; ">
	...
	<div style="width:960px; margin:0 auto; height:35px; position:relative; " >
		...
		<div style="position:absolute; top:3px; left:21px">
			<a href="http://kj.longeplay.com.tw" target="_blank">
				<img src="/p/img/gamebar/kj/logo.png">
			</a>
		</div>
		...
		<div style="position:absolute; right:200px; top:9px;" class="link">		
			<a href="https://www.facebook.com/long_e.inc" target="_blank"><img src="/p/img/gamebar/bw/b3_off.png" class="change"></a>			
			<img src="/p/img/gamebar/bw/line.png">			
			<a href="http://www.longeplay.com.tw/payment?game=kj" target="_blank"><img src="/p/img/gamebar/bw/b5_off.png" class="change"></a>			
			<img src="/p/img/gamebar/bw/line.png">			
