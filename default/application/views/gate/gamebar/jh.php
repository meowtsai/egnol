...
<div style="background:url(/p/img/gamebar/bg02.png) 0 -6px; height:35px; ">
	...
	<div style="width:960px; margin:0 auto; height:35px; position:relative; " >
		...
		<div style="position:absolute; top:-2px; left:46px">
			<a href="http://www.longeplay.com.tw/gate/website/jh" target="_blank">
		...
		<div style="position:absolute; right:200px; top:9px;" class="link">		
			...
			<a href="http://www.longeplay.com.tw/payment?game=jh" target="_blank"><img src="/p/img/gamebar/b5_off.png" class="change"></a>			
			<img src="/p/img/gamebar/line.png">			
			...
			<div id="info_block" class="marquee">
				<ul>
					...
					<li>
						...
						<!-- <a href="http://www.longeplay.com.tw/member/bind_account?redirect_url=http://jh.longeplay.com.tw" target="_blank" title="綁定帳號">綁定</a> -->
						<? endif;?>
					</li>
				</ul>
			</div>
