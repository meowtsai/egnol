...
<div style="background:url(/p/img/gamebar/my/bg02.png) 0 -6px; height:35px; ">
	<span style="display:inline-block; width:44px; height:41px; margin:-6px -12px 0 0 ; background:url('/p/img/gamebar/my/bg03.png') #000; float:right;"></span>
	<span style="display:inline-block; width:44px; height:41px; margin:-6px  0 0 -20px; background:url('/p/img/gamebar/my/bg01.png') #000; float:left;"></span>
		
	<div style="width:960px; margin:0 auto; height:35px; position:relative; " >
		
		<div style="position:absolute; top:-2px; left:20px">
			<a href="http://www.longeplay.com.tw/gate/website/my" target="_blank">
				<img src="/p/img/gamebar/my/logo.png" >
			</a>
		</div>
		
		<!-- new -->
		<div style="position:absolute; top:7px; left:125px; width:329px; height:24px; background:url('/p/img/gamebar/my/notice.png')">
			<div id="marquee_block"></div>
		</div>
		
		<div style="position:absolute; right:200px; top:9px;" class="link">		
			<a href="https://www.facebook.com/long_e.inc" target="_blank"><img src="/p/img/gamebar/my/b3_off.png" class="change"></a>			
			<img src="/p/img/gamebar/my/line.png">			
			<a href="http://www.longeplay.com.tw/payment?game=my" target="_blank"><img src="/p/img/gamebar/my/b5_off.png" class="change"></a>			
			<img src="/p/img/gamebar/my/line.png">			
			<a href="http://www.longeplay.com.tw/service" target="_blank"><img src="/p/img/gamebar/my/b4_off.png" class="change"></a>
		</div>
			...
			<div id="info_block" class="marquee">
				<ul>
					...
					<li>
						...
						<!-- <a href="http://www.longeplay.com.tw/member/bind_account?redirect_url=http://my.longeplay.com.tw" target="_blank" title="綁定帳號">綁定</a> -->
						<? endif;?>
					</li>
				</ul>
			</div>
