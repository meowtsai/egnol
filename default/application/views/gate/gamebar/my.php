...
<div style="background:url(/p/img/gamebar/my/bg02.png) 0 -6px; height:35px; ">
	...
	<div style="width:960px; margin:0 auto; height:35px; position:relative; " >
		...
		<div style="position:absolute; top:-2px; left:20px">
			<a href="http://www.long_e.com.tw/gate/website/my" target="_blank">
		...
		<div style="position:absolute; right:200px; top:9px;" class="link">		
			...
			<a href="http://www.long_e.com.tw/payment?game=my" target="_blank"><img src="/p/img/gamebar/my/b5_off.png" class="change"></a>			
			<img src="/p/img/gamebar/my/line.png">			
			<a href="http://www.long_e.com.tw/service" target="_blank"><img src="/p/img/gamebar/my/b4_off.png" class="change"></a>
		</div>
			...
			<div id="info_block" class="marquee">
				<ul>
					...
					<li>
						...
						<!-- <a href="http://www.long_e.com.tw/member/bind_account?redirect_url=http://my.long_e.com.tw" target="_blank" title="綁定帳號">綁定</a> -->
						<? endif;?>
					</li>
				</ul>
			</div>
