...
<div style="background:url(/p/img/gamebar/bw/bg02.png) 0 -6px; height:35px; ">
	...
	<div style="width:960px; margin:0 auto; height:35px; position:relative; " >
		...
		<div style="position:absolute; top:1px; left:21px">
			<a href="http://kw.longeplay.com.tw" target="_blank">
				<img src="/p/img/gamebar/ry/logo.png">
			</a>
		</div>
		...
		<div style="position:absolute; right:200px; top:9px;" class="link">		
			...
			<a href="http://www.longeplay.com.tw/payment?game=ry" target="_blank"><img src="/p/img/gamebar/bw/b5_off.png" class="change"></a>			
			<img src="/p/img/gamebar/bw/line.png">			
