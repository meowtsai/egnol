...
<div style="">
	<div style="width:960px; margin:0 auto; height:35px; position:relative; " >
		...
		<!-- menu -->
		<div class="menu" style="position:absolute; left:700px; top:-21px;">
		
			<? if ($is_minik_user == false):?>
			<a href="https://www.facebook.com/long_e.inc" target="_blank"><img src="/p/img/gamebar/xf/ingamebar_xf_off_04.png" class="change" style="height:56px;"></a>
