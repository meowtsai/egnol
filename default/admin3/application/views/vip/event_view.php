...
<div id="vip_event">
    ...
    <ul class="nav nav-tabs">
        <li class="<?=($this->input->get("ticket_status")==="0") ? "active" : ""?>">
            <a href="<?=site_url("vip/event_view/{$vip_event->id}?ticket_status=0")?>">取消</a>
        </li>
        <li class="<?=($this->input->get("ticket_status")==null || $this->input->get("ticket_status")==1) ? "active" : ""?>">
            <a href="<?=site_url("vip/event_view/{$vip_event->id}?ticket_status=1")?>">待匯款/新建</a>
        </li>
        <li class="<?=($this->input->get("ticket_status")==2) ? "active" : ""?>">
            <a href="<?=site_url("vip/event_view/{$vip_event->id}?ticket_status=2")?>">匯款完成</a>
        </li>
        <li class="<?=($this->input->get("ticket_status")==3) ? "active" : ""?>">
            <a href="<?=site_url("vip/event_view/{$vip_event->id}?ticket_status=3")?>">派發完成</a>
        </li>
        <li class="<?=($this->input->get("ticket_status")==4) ? "active" : ""?>">
            <a href="<?=site_url("vip/event_view/{$vip_event->id}?ticket_status=4")?>">結案</a>
        </li>
    </ul>
