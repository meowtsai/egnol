...
<fieldset>
  ...
  <div class="tab-content">
    ...
    <div class="tab-pane" id="divAdd">
      ...
      <input type="text" id="inputServiceInfo" name="inputServiceInfo" placeholder="備註(選填)" maxlength="500">
...
<fieldset>
  ...
  <div class="tab-content">
    ...
    <div class="tab-pane" id="divFeedbackAdd">
      ...
      <input type="text" id="inputServiceFeedbackInfo" name="inputServiceFeedbackInfo" placeholder="對話摘要" style="width:550px" maxlength="500">
