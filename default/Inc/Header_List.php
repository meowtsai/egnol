                ...
                <tr>
                                ...
                                <td width="157" align="left" valign="top">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr><td align="left" valign="top">
                                                        <img src="/img/tpc_e-newsicon007.jpg" name="tpc_e-newsicon007" id="tpc_e-newsicon007" />
                                                    </td></tr>
                                        <tr>
                    ...
                    ?>      
                                                                 ...
                                                                 <tr>
                                                                    <td align="left" valign="top">
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tr>        <td width="12"><img src="/img/tpc_e-newsicon045.jpg" name="tpc_e-newsicon111" id="tpc_e-newsicon111" /></td>
                                                                                            <td width="5"></td>
                    ...
                    ?>
                            ...
                            <tr>    <td width="12">　</td>
                              <td width="111" align="left" valign="top">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td class="TPC_e-newsListBg02" align="center" valign="top">
                                            <ul>
                                            <?php
                                                $query1 = "select ID,URL,Title,Description,sortorder from x_sitemap where ParentId=". $parentid." and visible=1  ORDER BY SortOrder asc";
                     ...
                     <!-- 功能列表 子區塊結束 -->
                                            ...
                                            <tr>
                                                <td><img src="/img/tpc_e-newsicon088.jpg" alt="" name="tpc_e-newsicon088" width="157" height="22" border="0" id="tpc_e-newsicon088" /></td>
                                            </tr>
                                    </table>
                                </td>       <td width="10">　</td>
                            </tr>
                    ...
                    <td align="left" valign="top">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <!-- 插入龍邑log -->
                            <tr><td align="center"><img src="/img/logo.gif" alt="" name="logo" width="450" height="60" border="0" id="logo" /></td></tr>
                            <tr>    <!-- <td width="5"></td> -->
                                <td align="left" valign="top">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                       ...
                                       <tr>
                                            <td align="left" valign="top">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">                                                 
                                                    ...
                                                    <tr>
                                                            <td width="21"><img src="/img/tpc_e-newsicon020.jpg" name="tpc_e-newsicon021" id="tpc_e-newsicon021" width="21" height="21" /></td>
                                                            ...
                                                            <td width="21"><img src="/img/tpc_e-newsicon025.jpg" name="tpc_e-newsicon025" id="tpc_e-newsicon025" /></td>
                                                                                                        ...
                                                                                                        <tr>    <td class="TPC_e-newsContentBg04"></td>
