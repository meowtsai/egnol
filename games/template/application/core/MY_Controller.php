...
class MY_Controller extends CI_Controller
{
	...
	{				
		...
		$this->g_layout
			...
			->set_meta("title", "《英雄獵人》龍邑遊戲_繁體中文網站")
			->set_meta("keywords", "英雄獵人")
			->set_meta("description", "《英雄獵人》");
		...
		$this->g_layout->set("game_id", "g1");			// 目前遊戲 game_id
		$this->g_layout->set("game_url", "/games/g1/");
