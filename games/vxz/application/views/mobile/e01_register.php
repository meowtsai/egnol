...
<div class="header01">		
	<div class="nav">
		<ul class="menu">
			<li id="btn_NEW" class="Nowtab"><a href="https://game.longeplay.com.tw/news?site=vxz">最新消息</a></li>
			<li id="btn_CHARACTER" class="Nowtab"><a href="https://www.facebook.com/playvxz/?fref=ts" target="_blank">粉絲團</a></li>
			<li id="btn_FB" class="Nowtab"><a href="https://game.longeplay.com.tw/service?site=vxz">客服中心</a></li>
...
<div class="header02">
	<div class="nav">
		<ul class="menu">
			<div class="icon"><img src="<?=base_url()?>p/img/mobile_e01/icon.png"></div>
			...
			<li id="btn_SERVICE" class="Nowtab"><a href="<?=base_url()?>mobile">回官網</a></li>
		</ul>
	</div>
</div>
<!-- 版頭人物 -->
	  ...
	  <div class="mv">
		...
		<img src="<?=base_url()?>p/img/mobile_e01/mv.png"></div>
		  ...
		  <div class="people1">
			 ...
			 <img src="<?=base_url()?>p/img/mobile_e01/lsh.png"></div>
		  </div>
		  ...
		  <div class="people2">
			 ...
			 <img src="<?=base_url()?>p/img/mobile_e01/sgjh.png"></div>
		  </div>
		  ...
		  <div class="tt">
			 ...
			 <img src="<?=base_url()?>p/img/mobile_e01/text.png"></div>
		  </div>
	  </div><!--top結尾-->
	  <!-- 事前登陸頁面 -->
	  <div class="section">
	   ...
	   <div id="all_tab">
		  <div id="btn_1" class="BOXS">
					...
					<form id="earlylogin_form" method="post" action="<?=base_url()?>mobile/e01_register_json">
	   <div class="fb-like">
	   ...
	   <p><input name="doLogin" type="submit" id="doSubmit" value="" class="button_submit" style="display:none;" />
							<div class="t4"><img src="<?=base_url()?>p/img/mobile_e01/login.png" class="button_submit" onclick="javascript:$('#doSubmit').trigger('click')"></div>
	   </p>
		<ul class="display">
		 <li class="t5">事前登錄序號</li>
		 <li><span class="t6"><?=$earlylogin_serial?></span></li>
		 <li class="t7">情緣合擊序號</li>
		 <li><span class="t8"><?=$combo_serial?></span></li>
		</ul>
					</form>
	 </div>
		 <div id="btn_2" class="BOXS">
	   <ul>
		 <li class="t9"><input type="text" id="website" style="width:480px;" value="<?=($share_code)?base_url()."mobile/e01_register?receive_code=".$share_code:"";?>" /></li>
	   </ul>
		 <p><div class="t10"><img data-copytarget="#website" onclick="javascript:alert('<?=($share_code)?"分享網址已加入剪貼簿":"請先完成預約登錄"?>')" style="cursor:copy;" src="<?=base_url()?>p/img/mobile_e01/copy.png"></div></p> 
	 </div>
  </div>
...
05. 每個遊戲帳號僅能兌換一次事前登錄獎勵。<br/>06. 活動序號不得轉換、轉讓及折換現金。<br/>07. 官方保留活動隨時修改條款的權利，如有任何爭議，皆以主辦單位之解釋及本活動的最終決策權為準。<br/>08. 如本活動因不可抗力之特殊原因無法執行時，主辦單位有權決定取消、終止、修改或暫停本活動。<br/>09. 本活動之所有物品均不得要求官方轉換、轉讓、折換現金或遊戲道具、貨幣。<br/>10. <font color="c20b66">事前登錄序號可於封測啟動後進入《小李飛刀》遊戲內兌換，請大俠自行保留序號。</font><br/>11. 情緣合擊分享碼相關資訊：</p>
	  <p class="box2">(1) 此情緣合擊分享網址可分享給一位朋友，只要朋友點擊該網址並成功預約登錄，兩人便完成了情緣合擊，皆可獲得情緣合擊禮包序號。<br/>(2) 一人僅能領取一份情緣合擊分享禮包序號。<br/>
例：李尋歡第一次進行預約登錄後拿到情緣合擊分享碼，將分享碼分享給阿飛，阿飛在成功預約登錄後也可至情緣合擊分享碼裡拿到一組分享碼，阿飛再將自己的分享碼給林仙兒，林仙兒便也可透過阿飛的分享碼取得禮包序號。但阿飛只會擁有一組禮包序號，不會因為林仙兒成功輸入而多增加一份。</p><p>12. 若有活動相關問題，請洽<a href="#">官網/客服中心</a>。</p>
<!---"mailto:信箱"--->
	 </div><!--box1結尾-->
</div><!--article結尾-->
<!-- 頁尾 -->       
<div class="footer"><img src="<?=base_url()?>p/img/mobile_e01/footer.jpg" /></div>
</div><!--wrapper結尾-->          
<!-- GO TOP -->	
<div id="gotop"><img src="<?=base_url()?>p/img/mobile_e01/totop_01.png" width="156" height="243"></div>
<!-- JQ -->
<script src="<?=base_url()?>p/js/mobile_e01/jquery-1.12.3.min.js" type="text/javascript"></script>
...
<script src="<?=base_url()?>p/js/mobile_e01/jquery.colorbox.js"></script>
<script src="<?=base_url()?>p/js/mobile_e01/jquery.colorbox-min.js"></script>
...
<script src="<?=base_url()?>p/js/mobile_e01/wow.js"></script>
...
$(".back a, #NEW, #SLIDERBOX, #TOP, #HEROS, #service, #footer").click(function(){
$(".nav2").fadeOut();
return false;
});
});
