...
*/
	...
	function e03_transfer()
	{
    $useragent=$_SERVER['HTTP_USER_AGENT'];

		$this->_init_layout()
			->set_meta("title", "小李飛刀玩家獨享元寶活動")
			->add_css_link(array('event/bootstrap.min','event/e03_cover'))
			->add_js_include(array('event/bootstrap.min', 'event/jquery-slim.min', 'event/popper.min'))
			->api_view();
	}
}
